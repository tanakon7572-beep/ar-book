    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
            <div style={{ width: '100%', maxWidth: '400px' }}>
                ...
                {/* Login Glass Panel */}
                <div className="glass-panel fade-up" style={{ padding: '40px', animationDelay: '0.1s', border: '1px solid rgba(255,0,128,0.2)' }}>
                ...
                <div className="text-center mt-10 fade-up" style={{ animationDelay: '0.2s' }}>
                    <Link href="/shelf" style={{ color: 'var(--c-text-3)', textDecoration: 'none', fontSize: '0.9rem', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '2px' }}>
