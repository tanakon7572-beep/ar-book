...
export default function AdminShelvesPage() {
    ...
    return (
        <AdminLayout>
            ...
            {/* Add Shelf Section */}
            <div className="glass-panel mb-12 fade-up" style={{ padding: '32px', animationDelay: '0.1s', border: '1px solid rgba(255,255,255,0.08)', boxShadow: '0 12px 40px rgba(0,0,0,0.3)' }}>
            ...
            {loading ? (
                ...
                <div className="glass-panel text-center fade-up" style={{ padding: '100px 40px', borderStyle: 'dashed', animationDelay: '0.2s', borderWidth: '2px', borderColor: 'rgba(255,255,255,0.1)' }}>
                ...
                <div style={{ display: 'grid', gap: '32px' }}>
                    {shelves.map((shelf, idx) => (
                        <div key={shelf.id} className="glass-panel fade-up" style={{ padding: '36px', animationDelay: `${idx * 0.1}s`, position: 'relative', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.08)' }}>
                            ...
                            {/* Mini Previews */}
                            <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', padding: '24px', background: 'rgba(0,0,0,0.3)', borderRadius: '20px', border: '1px solid rgba(255,255,255,0.03)' }}>
